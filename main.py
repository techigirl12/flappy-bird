...
FPS = 32 #framepersecond
SCREENWIDTH = 289
SCREENHEIGHT = 511
#set the height and width of the window
SCREEN = pygame.display.set_mode((SCREENWIDTH, SCREENHEIGHT)) #display the screen through pygame
    ...
    while True:
        for event in pygame.event.get():
            ...
            # If the user presses space or up key, start the game for them
                ...
                SCREEN.blit(GAME_SPRITES['background'], (0, 0)) #blit means sticking
...
if __name__ == "__main__":
    ...
    pygame.display.set_caption('Flappy Bird by Sakshi')
    GAME_SPRITES['numbers'] = (
        pygame.image.load('sprites/0.png').convert_alpha(), #convert_alpha means it makes the changes in images of pixels
